The theoretical motivation for studying the ssWW process--and VBS in general--is detailed in Section~\ref{ssww13tev:vbs_theory}.
...
The LL events prefer lower $\pt$ for both signal leptons (see Figure~\ref{fig:polarization_leppt}), which motivates keeping cuts on these quantities as low as possible in the event selection.% in order to preserve as much longitudinal polarization as possible.

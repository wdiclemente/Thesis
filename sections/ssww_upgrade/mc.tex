As this is a prospects study for a future collider, all signal and background processes are modeled using MC simulations.
The samples are generated at the expected HL-LHC center of mass energy \com{14}, and the event yields are scaled to the anticipated integrated luminosity of $\mathcal{L}=3000~\textrm{fb}^{-1}$.

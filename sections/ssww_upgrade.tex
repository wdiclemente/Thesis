...
On December 3, 2018, Run 2 of the LHC officially ended, and the collider was shut down to begin the first of two scheduled extended maintenance periods~\cite{2018.cern-press-run2}.
...
The upgraded detector, the higher beam energy, and the increased volume of data to be collected provides the opportunity to measure rare processes to a much higher precision than what is possible with the current LHC dataset.

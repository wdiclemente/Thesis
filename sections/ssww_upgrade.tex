...
The HL-LHC is planned to run at a center-of-mass energy of \com{14} with an instantaneous luminosity of $\mathcal{L}=5\times 10^{34}~\textrm{cm}^{-2}\textrm{s}^{-1}$ corresponding to an average of 140 collisions per beam-crossing. 

...
As explained in Section~\ref{sec:theory_vbs}, in the absence of a light SM Higgs boson, the scattering amplitude of longitudinally polarized vector bosons grows with center-of-mass energy.% and ultimately violates unitarity above \com{1} in the absence of a light SM Higgs boson~\cite{1977.ben-lee-weak-interactions, 2009.strong-gauge-boson-scattering}.
...
%This particular aspect of VBS theory will be covered in more detail in Section~\ref{sswwupgrade:theory} in the context of the future prospects of a \ssww measurement at the HL-LHC.

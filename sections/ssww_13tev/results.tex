...
\begin{equation}
  \mu_{WZ} = 0.88^{+0.07}_{-0.07}(\textrm{stat})~^{+0.31}_{-0.21}(\textrm{model\ sys})~^{+0.22}_{-0.11}(\textrm{experimental\ sys})
...
\begin{equation}
  \mu_{\textrm{obs}} = 1.45^{+0.25}_{-0.24}(\textrm{stat})~^{+0.27}_{-0.22}(\textrm{sys})\,. % paper has no theory uncert for some reason
...
The observed number of data events are compared to the predicted signal and background yields in the signal region after applying the fit in Table~\ref{tab:ssww13tev_yields_postfit}.
The pre-fit event yields can be found in Appendix~\ref{app:ssww13tev_prefit}.
...
\begin{equation}
  \sigma_{\textrm{meas}}^{\textrm{fid}} = 2.91^{+0.51}_{-0.47}(\textrm{stat})~^{+0.12}_{-0.16}(\textrm{model\ sys})~^{+0.24}_{-0.23}(\textrm{experimental\ sys})~^{+0.08}_{-0.06}(\textrm{luminosity})~\textrm{fb}\,.

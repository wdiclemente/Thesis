...
The isolation workingpoint used for the signal muons, \tt{Gradient}, is defined such that there is 90\% or better background rejection for $25\gev$ muons, and 99\% efficiency at $60\gev$.
...
\TODO{MET and b-tag descriptions}
...
In order to account for the two final state neutrinos, the event must contain $\met > 30\gev$. \TODO{brief blurb on MET reconstruction/corrections}
...
Events are vetoed if they contain one or more jets that have been tagged as a $b$-jet using the MV2c20 tagger operating at the 85\% efficiency workingpoint~\cite{2018.btag-efficiency-13tev} to suppress backgrounds from heavy flavor decays (especially top quark events). \TODO{Make less jargony or one sentence to explain b-tagging}

...
In early 2015, at the start of the LHC's second data-taking run (Run 2), I assisted with the validation of the first set of alignment constants using \com{13} proton-proton collision data.
...
The final two analyses I worked on involved the scattering of same-sign $W$ bosons, and they make up the majority of this thesis.

...
\renewcommand\Zee{Z\rightarrow e^{\pm}e^{\mp}}
\newcommand\mll{m_{ll}}
...
\newcommand\mum{\mu\textrm{m}} %micrometer
\newcommand\nm{\textrm{nm}} %nanometer
...
\newcommand\sigmatottheo{\sigma_{\textrm{theo}}^{\textrm{tot}}}
...
\newcommand\eop{\langle E/p\rangle}

\newcommand\gtsu[1]{\textrm{SU}(#1)}
\newcommand\gtso[1]{\textrm{SO}(#1)}
\newcommand\gtu[1]{\textrm{U}(#1)}
